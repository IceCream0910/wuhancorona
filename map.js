...
var geojson_hospital = {
  ...
  },
  {
    ...
    properties: {
      title: '대구의료원(8)',
      description: '(20-02-18 31~36번 확진자/20-02-19 42, 45, 46번 확진자) 검사 결과 양성 확인 후 해당 병원에서 격리 치료.'
    }
  },
  {
    type: 'Feature',
    ...
    properties: {
      title: '경북대학교병원(3)',
      description: '(20-02-18 37, 38번 확진자/20-02-19 44번 확진자) 검사 결과 양성 확인 후 해당 병원에서 격리 치료.'
    }
  },
  {
    type: 'Feature',
  ...
  },            
   {
    ...
    properties: {
      title: '계명대학교병원',
      description: '(20-02-19 43번 확진자) 검사 결과 양성 확인 후 해당 병원에서 격리 치료.'
    }
  },           
]
};
          ...
          },
          {
            ...
            },
            {
...

             {
                    ...
                    description: '(20-02-18 31번 확진자) [2월 9일] 오전 7시 30분 자차 이용해 방문.<br>[2월 16일] 오전 7시 20분경 택시 이용해 방문. '
                                }
                              },
